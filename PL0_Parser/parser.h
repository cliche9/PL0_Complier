...
public:
    ...
    void printQuad(ostream &out) const;             // 输出四元式表
...
private:
    ...
    void monomialQuad(string opr);                  // 单目运算符的四元式
    void binomialQuad(string opr);                  // 双目运算符的四元式
    /* ========= 辅助函数 ========== */
